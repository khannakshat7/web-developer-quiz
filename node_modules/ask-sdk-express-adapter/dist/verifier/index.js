...
var SkillRequestSignatureVerifier = /** @class */ (function () {
    ...
    SkillRequestSignatureVerifier.prototype.verify = function (requestEnvelope, headers) {
        return __awaiter(this, void 0, void 0, function () {
            var signatureCertChainUrl, signature, pemCert, err_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        signatureCertChainUrl = headers[SIGNATURE_CERT_CHAIN_URL_HEADER.toLowerCase()];
                        signature = headers[SIGNATURE_HEADER.toLowerCase()];
